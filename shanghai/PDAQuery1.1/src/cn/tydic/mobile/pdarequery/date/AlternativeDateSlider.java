...
package cn.tydic.mobile.pdarequery.date;
...
import cn.tydic.mobile.pdarequery.date.TimeView.DayTimeLayoutView;
...
public class AlternativeDateSlider extends DateSlider {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mYearScroller.setLabeler(yearLabeler, mTime.getTimeInMillis(),180,100);
		...
		mMonthScroller.setLabeler(monthLabeler, mTime.getTimeInMillis(),150,100);
		...
		mDayScroller.setLabeler(dayLabeler, mTime.getTimeInMillis(),45,100);
